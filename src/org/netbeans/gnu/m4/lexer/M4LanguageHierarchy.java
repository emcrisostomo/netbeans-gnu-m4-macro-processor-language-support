...
public class M4LanguageHierarchy extends LanguageHierarchy<M4TokenId> {
    ...
    private static void init() {
        ...
        tokens = Arrays.asList(new M4TokenId[]{
            ...
            new M4TokenId("NARGS", "m4-builtin-macro", regExCounter++),
            ...
            new M4TokenId("REVERSE", "m4-builtin-macro", regExCounter++),
            new M4TokenId("COND", "m4-builtin-macro", regExCounter++),
            new M4TokenId("JOIN", "m4-builtin-macro", regExCounter++),
            new M4TokenId("JOINALL", "m4-builtin-macro", regExCounter++),
            new M4TokenId("QUOTE", "m4-builtin-macro", regExCounter++),
            new M4TokenId("DQUOTE", "m4-builtin-macro", regExCounter++),
            new M4TokenId("DQUOTE_ELT", "m4-builtin-macro", regExCounter++),
            new M4TokenId("ARGN", "m4-builtin-macro", regExCounter++),
            new M4TokenId("FORLOOP", "m4-builtin-macro", regExCounter++),
            new M4TokenId("FOREACH", "m4-builtin-macro", regExCounter++),
            new M4TokenId("FOREACHQ", "m4-builtin-macro", regExCounter++),
            new M4TokenId("STACK_FOREACH", "m4-builtin-macro", regExCounter++),
            new M4TokenId("STACK_FOREACH_LIFO", "m4-builtin-macro", regExCounter++),
            new M4TokenId("DEFINE_BLIND", "m4-builtin-macro", regExCounter++),
            new M4TokenId("CURRY", "m4-builtin-macro", regExCounter++),
            new M4TokenId("COPY", "m4-builtin-macro", regExCounter++),
            new M4TokenId("RENAME", "m4-builtin-macro", regExCounter++),
            ...
            new M4TokenId("CLEARDIVERT", "m4-builtin-macro", regExCounter++),
            ...
            new M4TokenId("UPCASE", "m4-builtin-macro", regExCounter++),
            new M4TokenId("DOWNCASE", "m4-builtin-macro", regExCounter++),
            new M4TokenId("CAPITALIZE", "m4-builtin-macro", regExCounter++),
